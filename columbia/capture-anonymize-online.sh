...
xmlstarlet ed -u /triggerconf/module/submodule/configitem[@name='"Output"'] -v $1 temp.xml > curr.xml
rm temp.xml
...
tcpdump -i enp0s25 -W $MAX_FILES -C $MAX_FILESIZE_STR -w - | pktanon curr.xml
